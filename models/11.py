from data.DataManager import generate_sequential_data11, preprare_seq_seq_data
...
def trainSemLM11(train_texts, valid_texts,  dep=1,hidden_size=32, batch_size=1000, save_folder=".", model_name="simple", max_epochs=5,
                 ):

    X,Y,Xv,Yv,map_key = generate_sequential_data11(train_texts, valid_texts)
